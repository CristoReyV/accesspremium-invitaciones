...
export default function InvitationRouting({ children }: { children: ReactNode }) {
  ...
  // Panel hostname: render panel app entirely (panel.invitaciones-access.smartbrain.lat)
  ...
  // Path-based panel route: /panel
  // En hosts de cliente nunca se permite acceder a /panel ni mezclarse con invitaciones
